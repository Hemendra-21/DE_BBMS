...
(`test_id`, `donor_id`, `donation_id`, `technician_id`, `date`, `disease_tested`, `result`, `test_type`, `comments`) 
VALUES
(61, 1, 1, 3, '2020-10-16', '', 'Positive', 'Blood Typing', 'Blood type A+'),
(62, 2, 2, 4, '2021-01-21', 'HIV', 'Negative', 'Disease Screening', 'Clear of HIV'),
(63, 3, 3, 3, '2021-02-19', '', 'Positive', 'Blood Typing', 'Blood type B+'),
(64, 4, 4, 17, '2020-12-06', 'Hepatitis B', 'Negative', 'Disease Screening', 'No hepatitis B detected'),
(65, 5, 5, 9, '2021-03-11', '', 'Positive', 'General Health', 'No health issues found'),
(66, 6, 6, 6, '2020-09-23', 'HIV', 'Negative', 'Disease Screening', 'No HIV'),
(67, 7, 7, 20, '2020-11-13', '', 'Positive', 'Blood Typing', 'Blood type O-'),
(68, 8, 8, 9, '2021-01-31', 'Hepatitis B', 'Negative', 'Disease Screening', 'No issues detected'),
(69, 9, 9, 16, '2020-08-20', '', 'Positive', 'General Health', 'Healthy donor'),
(70, 10, 10, 11, '2021-03-06', 'HIV', 'Negative', 'Disease Screening', 'Negative result'),
(71, 11, 11, 13, '2020-07-12', '', 'Positive', 'Blood Typing', 'Blood type AB+'),
(72, 12, 12, 14, '2021-02-06', 'Hepatitis B', 'Negative', 'Disease Screening', 'Test is clear'),
(73, 13, 13, 15, '2020-10-29', '', 'Positive', 'General Health', 'Good health'),
(74, 14, 14, 5, '2021-04-10', 'HIV', 'Negative', 'Disease Screening', 'HIV test negative'),
(75, 15, 15, 5, '2020-08-31', '', 'Positive', 'Blood Typing', 'Blood type A-'),
(76, 16, 16, 7, '2021-01-16', 'Hepatitis B', 'Negative', 'Disease Screening', 'Negative for hepatitis B'),
(77, 17, 17, 7, '2020-11-21', '', 'Positive', 'General Health', 'No health issues'),
(78, 18, 18, 7, '2021-03-21', 'HIV', 'Negative', 'Disease Screening', 'All clear'),
(79, 19, 19, 16, '2020-09-06', '', 'Positive', 'Blood Typing', 'Blood type O+'),
(80, 20, 20, 16, '0000-00-00', 'Hepatitis B', 'Negative', 'Disease Screening', 'Hepatitis B not detected');
...
--
INSERT INTO recipients (recipient_id, name, age, blood_group, location) VALUES
(1, 'Alex Johnson', 45, 'A+', 'Gatineau'),
(2, 'Maria Rodriguez', 37, 'O-', 'Longueuil'),
(3, 'David Smith', 29, 'B+', 'Granby'),
(4, 'Emma Wilson', 53, 'AB-', 'Dollard-Des Ormeaux'),
(5, 'Michael Brown', 62, 'A-', 'Repentigny'),
(6, 'Sophia Davis', 26, 'O+', 'Dollard-Des Ormeaux'),
(7, 'James Garcia', 34, 'B-', 'Mascouche'),
(8, 'Isabella Martinez', 47, 'AB+', 'Laval'),
(9, 'William Anderson', 39, 'A+', 'Longueuil'),
(10, 'Olivia Thomas', 55, 'O-', 'Repentigny'),
(11, 'Benjamin Lee', 43, 'B+', 'Mascouche'),
(12, 'Charlotte Jones', 50, 'AB-', 'Gatineau'),
(13, 'Lucas White', 28, 'A-', 'Sherbrooke'),
(14, 'Mia Harris', 31, 'O+', 'Saint-Jean-sur-Richelieu'),
(15, 'Mason Clark', 36, 'B-', 'Dollard-Des Ormeaux'),
(16, 'Amelia Young', 41, 'AB+', 'Drummondville'),
(17, 'Elijah Allen', 59, 'A+', 'Longueuil'),
(18, 'Harper Walker', 24, 'O-', 'Côte-Saint-Luc'),
(19, 'Ethan King', 38, 'B+', 'Brossard'),
(20, 'Ava Wright', 48, 'AB-', 'Brossard');
...
--
-- Dumping data for table `recipient_requests`
--

INSERT INTO requests (request_id, recipient_id, hospital_id, required_date, urgency) VALUES
(1, 1, NULL, '2023-06-15', 'medium'),
(2, 2, NULL, '2023-07-20', 'low'),
(3, 3, 3, '2023-05-11', 'high'),
(4, 4, 4, '2023-08-04', 'medium'),
(5, 5, 5, '2023-09-09', 'low'),
(6, 6, 6, '2023-10-12', 'high'),
(7, 7, 7, '2023-11-06', 'medium'),
(8, 8, 8, '2023-04-21', 'low'),
(9, 9, 9, '2023-03-15', 'high'),
(10, 10, 10, '2023-12-20', 'medium'),
(11, 11, 11, '2023-01-11', 'low'),
(12, 12, 12, '2023-02-04', 'high'),
(13, 13, 13, '2023-06-09', 'medium'),
(14, 14, 14, '2023-07-12', 'low'),
(15, 15, 15, '2023-05-06', 'high'),
(16, 16, 16, '2023-03-21', 'medium'),
(17, 17, 17, '2023-11-15', 'low'),
(18, 18, 18, '2023-08-20', 'high'),
(19, 19, 19, '2023-09-11', 'medium'),
(20, 20, 20, '2023-04-04', 'low');
